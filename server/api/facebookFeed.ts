export default defineEventHandler(async (event) => {
  ...
  const feed = await $fetch(`https://graph.facebook.com/v20.0/${facebookPageId}/feed?fields=message,id,full_picture,created_time,permalink_url&offset=${offset}&limit=${limit}&access_token=${facebookAccessToken}`, { method: 'GET' });
